...
export LAYER2_SNAPSHOT_BUCKET='${LAYER2_SNAPSHOT_BUCKET}'
export LAYER2_SNAPSHOT_PREFIX='${LAYER2_SNAPSHOT_PREFIX}'
export LOCAL_SNAPSHOT_CACHE_DIR='${LOCAL_SNAPSHOT_CACHE_DIR}'
EOF
