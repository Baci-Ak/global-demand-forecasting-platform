...
def include_object(object, name, type_, reflected, compare_to):
    # Only include objects in the audit schema
    if type_ == "table":
        return object.schema == AUDIT_SCHEMA
    return True
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        # Important when using non-public schemas
        include_schemas=True,
        include_object=include_object,
        version_table="audit_alembic_version",
        # Store alembic version table in the audit schema
