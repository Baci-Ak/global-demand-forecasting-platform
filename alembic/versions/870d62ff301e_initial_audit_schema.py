...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('idx_ingestion_runs_source_date', table_name='ingestion_runs', schema='audit_testing')
    op.drop_table('ingestion_runs', schema='audit_testing')
    op.drop_index('idx_dq_runs_dataset_time', table_name='dq_runs', schema='audit_testing')
    op.drop_table('dq_runs', schema='audit_testing')
    # ### end Alembic commands ###
